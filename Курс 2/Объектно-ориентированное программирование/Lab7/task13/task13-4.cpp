...
class Test: public BigOne
{
	...
	public:
		double SredniaTwo()=0;
		Test(int _studenci1, int _nauczycieli1, int _studenci2, int _nauczycieli2, int _isgymnazium);

};
BigOne::BigOne(int _studenci1, int _nauczycieli1, int _studenci2, int _nauczycieli2, int _isgymnazium): OrGymnazium1(_studenci2, _nauczycieli2, _isgymnazium)
{
	Szkola1 = Szkola(_studenci1, _nauczycieli1);
}
double Test::SredniaTwo()
{
	return Szkola1.Srednia() + OrGymnazium.Srednia();
}

Test::Test(int _studenci1, int _nauczycieli1, int _studenci2, int _nauczycieli2, int _isgymnazium): BigOne(_studenci1, _nauczycieli1, _studenci2, _nauczycieli2, _isgymnazium)
{
}
